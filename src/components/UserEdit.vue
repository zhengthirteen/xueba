  ...
  <div class="layout">
    ...
    <div class="main">
      ...
      <div class="user-profile">
        <!-- 隐藏的文件输入框，当点击头像时触发 -->
        <input type="file" accept="image/*" ref="fileInput" @change="handleAvatarChange" style="display: none;" />
      ...
      <div class="user-address">
        ...
        <input id="address" v-model="address" type="text" placeholder="请输入地址" />
      </div>
...
export default {
  ...
  setup() {
    ...
    const saveProfile = async () => {
      ...
      try {
        const response = await axios.post("https://your-api-endpoint.com/api/user/update", userData);
    ...
    return { user, email, phone, address, school, saveProfile, cancelEdit, triggerFileInput, handleAvatarChange };
  },
};
</script>
